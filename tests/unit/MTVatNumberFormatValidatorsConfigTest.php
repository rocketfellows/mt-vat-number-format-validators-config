...
namespace rocketfellows\MTVatNumberFormatValidatorsConfig\tests\unit;
...
use rocketfellows\MTVatNumberFormatValidatorsConfig\MTVatNumberFormatValidatorsConfig;

class MTVatNumberFormatValidatorsConfigTest extends TestCase
{
    private const TESTING_CONFIG_CLASS = MTVatNumberFormatValidatorsConfig::class;
    private const EXPECTED_CONFIG_DEFAULT_VALIDATOR_CLASS = MTVatFormatValidator::class;
    ...
    {
        $this->assertEquals(ISO3166::MT(), $config->getCountry());
    }
